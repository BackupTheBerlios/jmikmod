...
public class Vox_Driver extends clDRIVER
{

static {
    System.loadLibrary("drvvox");
}
...
native int sysCloseSound(int hFile);
native int sysWriteBuffer(int hFile, byte bBuffer[], int iLen);

    
public Vox_Driver(clMain theMain)
{
    super(theMain);
    sndfd = 0;
    fragmentsize = 0;
    ...
    Name = new String("Open Sound System (OSS)");
    Version = new String("Open Sound System (OSS) Driver v1.2 - by Rao & MikMak");
}
