...
#include "MikMod_Drivers_Native_Driver.h"


JNIEXPORT jint JNICALL Java_MikMod_Drivers_Native_Driver_sysCheckAccess(
                                                                        JNIEnv* theEnv,
                                                                        jobject theClass)
{
...
JNIEXPORT jint JNICALL Java_MikMod_Drivers_Native_Driver_sysOpenSound(
                                                                      JNIEnv* theEnv,
                                                                      jobject theClass,
                                                                      jint iFreq,
                                                                      jint iBitsNum,
...
JNIEXPORT jint JNICALL Java_MikMod_Drivers_Native_Driver_sysCloseSound(
                                                                       JNIEnv* theEnv,
                                                                       jobject theClass,
                                                                       jint hFile)
{
...
JNIEXPORT jint JNICALL Java_MikMod_Drivers_Native_Driver_sysWriteBuffer(
                                                                        JNIEnv* theEnv,
                                                                        jobject theClass,
                                                                        jint hFile,
                                                                        jarray bBuffer,
